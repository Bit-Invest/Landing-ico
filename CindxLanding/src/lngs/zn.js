...
const zn = {
    ...
    'headerTimer#1': '距离Bitforex上的初始交易所产品预发行开始还有',
    'headerTimer#2': 'D',
    'headerTimer#3': 'H',
    'headerTimer#4': 'M',
    'headerTimer#5': 'S',
...
//    'menu#8': '销售详情',
    ...
    'mailForm#30': '加密货币资产管理的一站式解决方案',
    'mailForm#31': '投资加密货币变得更容易、安全及快捷。',
    'mailForm#32': '订阅 Cindx 的最新消息',
    'mailForm#33': '预定',
    'mailForm#34': '招股书',
    'mailForm#35': '白皮书',
    'mailForm#36': '',
 ...
 //   'ourTopRatings#1': 'Our Top Ratings',
    ...
    'cryptoAssetsManagement#16': 'CINDX.trade 是交易员可在一个地方交易不同交易所加密资产、分析市场、自动交易和实现突出收益的模块',
...
*/  'roadmap#24': '发展蓝图',
    ...
    'marketAnalytics#5': '2018年加密货币的价格整体呈下降趋势，但随着在资金管理下，新的流动性被引入的资产，行业继续发展。',
    'marketAnalytics#6': '',
    'marketAnalytics#7': '2017年和2018年地区隔离的在线交易商数量增长。2018年的领导者是亚洲和欧洲，主要是由于加密交易的出现，加密交易的入门门槛较低。',
    'marketAnalytics#8': '',
    "marketAnalytics#_9": '加密市场的交易量已经超过2017年底的加密货币大肆宣传的数量。尽管几乎每年的熊市，但正如研究数据所示，交易正在非常积极地发展。',
    "marketAnalytics#_10": '',
    ...
    'marketAnalytics#15': '超过2500万潜在的经理和交易员',
    'marketAnalytics#16': '',
    'marketAnalytics#17': '每天超过1亿潜在投资者及交易',
    'marketAnalytics#18': '每天交易',
...
*/
    ...
    'feedbackProject#4': 'Innov8 Global Ventures的合伙人|咨询|实验室',
    ...
    'feedbackProject#14': '“CINDX是一个很好的想法，可以解决加密货币和代币投资的所有不足。”',
    ...
    'feedbackProject#27': '“CINDX不仅为所有投资者及交易员提供复杂的工具，而且还提供了一个平台，让我们可以依靠经验丰富的交易员的经验复制交易。”',
    ...
    'feedbackProject#32':'“通过让新交易员跟踪有经验的交易者的交员，CINDX消除了缺乏经验导致亏钱的担忧。”',
    ...
    'feedbackProject#53': '“任何旨在简化投资者、经理和供应商工作的创新解决方案代表了加密货币投资市场的潜在破坏性模式。”',
    'feedbackProject#54': 'Jason King',
    'feedbackProject#55': 'CINDX 顾问',
    'feedbackProject#56': 'Telenor首席执行官',
    'feedbackProject#57': '视频',
    'feedbackProject#58': '“CINDX确实可以为大众市场投资者揭开加密货币交易世界的神秘面纱。这为普通小投资者提供了一个奋斗的机会，让他们能够以一种更公平、更透明的方式，进入并参与与其身份相符的交易。”',
    ...
    'teamAdvisersPartners#109': 'Blockchainer在人才、组织和信息三个方面加速了商业部门的网络发展。',
    ...
    'teamAdvisersPartners#175': 'Saisanit先生毕业于泰国易三仓大学，拥有执行管理MBA和市场营销BBA专业。',
    ...
    'teamAdvisersPartners#188': 'Reinhard Berger是该公司是一家专注于创新DLT技术的迪拜风险投资公司Pecunio Blockchain Technologies的首席执行官。',
    ...
    'teamAdvisersPartners#194': '掌舵Pecuino的直观领导者，天生导师和真正的战略家。',
