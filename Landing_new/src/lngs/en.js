...
const en = {
    ...
    'mailForm#32': 'Subscribe to the latest updates from Cindx',
    'mailForm#33': 'Subscribe',
    ...
    'cryptoAssetsManagement#15': 'CINDX.market is a marketplace for investors where they can evaluate and select strategies to follow or index to invest.',
    'cryptoAssetsManagement#16': 'CINDX.trade is a module for traders to trade crypto assets on different exchange in one place, analyse the market, automate trading and achieve outstanding gains.',
    'cryptoAssetsManagement#17': 'CINDX uses API for data collection and trades execution. API and secret keys are not less secure than users’ login and password. To protect CINDX users, we keep all the secret API keys in a separate database using bank- level encryption.',
    'cryptoAssetsManagement#18': 'CINDX.HUB',
    'cryptoAssetsManagement#19': 'CINDX.hub is component for algorithmic strategies creating, historical testing and analysis with the number of ready to use solutions provided.',
    'cryptoAssetsManagement#20': 'HUB.Pro is an option for professional traders which allows to automate their trading strategies for 24/7 trading and earning.',
    'cryptoAssetsManagement#21': 'HUB.Lite is an option for investors who can work with proven instruments with flexible risk settings.',
    ...
    'marketAnalytics#5': 'The overall crypto fund industry has been growing rapidly. Changes in assets are a result of three primary factors: the launching of new crypto funds, net inflows to existing funds, and changes in the value of portfolio assets.',
    ...
    'marketAnalytics#15': 'More than 25 million potential Managers and Traders clients',
    'marketAnalytics#16': '',
