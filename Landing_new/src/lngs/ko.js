...
//   'docPopup#1': 'Receive all documents in your email',
 ...
 //   'ourTopRatings#1': 'Our Top Ratings',
    ...
    'cryptoAssetsManagement#15': 'CINDX.market 투자자를위한 시장으로, 따라야 할 전략이나 투자 지표를 평가하고 선택할 수 있습니다..',
    'cryptoAssetsManagement#16': 'CINDX.trade 한 곳에서 서로 다른 거래소에서 암호 거래를 거래하고, 시장을 분석하고, 거래를 자동화하고, 뛰어난 이익을 달성하는 거래자를위한 모듈입니다.',
    'cryptoAssetsManagement#17': 'CINDX 데이터 수집 및 거래 실행을 위해 API를 사용합니다. API 및 비밀 키는 사용자의 로그인 및 비밀번호 세부 정보보다 안전합니다. CINDX 사용자를 보호하기 위해 모든 비밀 API 키를 뱅크 수준 암호화를 사용하여 별도의 데이터베이스에 보관합니다.',
    'cryptoAssetsManagement#18': 'CINDX.HUB',
    'cryptoAssetsManagement#19': 'CINDX.hub 바로 사용할 수있는 솔루션으로 알고리즘 전략, 내역 테스트 및 분석을 생성하기위한 구성 요소입니다.',
    'cryptoAssetsManagement#20': 'HUB.Pro 24/7 거래 및 수입을위한 거래 전략을 자동화 할 수있는 전문 상인을위한 옵션입니다.',
    'cryptoAssetsManagement#21': 'HUB.Lite 유연한 위험 설정으로 뒷받침 된 검증 된 도구로 작업 할 수있는 투자자를위한 옵션입니다.',
...
*/
 'roadmap#24': 'Roadmap',
    ...
    'marketAnalytics#8': '',
    "marketAnalytics#_9": '암호화 시장에서의 거래량은 이미 암호화 통화가 과장된 2017 년 말의 거래량을 이미 초과했습니다. 거의 매년 곰 시장에도 불구하고, 연구 데이터로 표시된 바와 같이 거래는 매우 활발하게 발전하고 있습니다.',
    "marketAnalytics#_10": '',
    ...
    'marketAnalytics#15': '2,500 만 명 이상의 잠재적 인 관리자 및 거래자',
    'marketAnalytics#16': '',
    'marketAnalytics#17': '1 억 명 이상의 잠재 투자자',
    'marketAnalytics#18': '매일 거래',
    'marketAnalytics#19': '1000 개 이상의 기관 파트너,',
    'marketAnalytics#20': '각각 3-5 억 달러',
...
*/
    ...
    'feedbackProject#32':'"경험 많은 상인의 추적자. CINDX는 경험이 없다는 피할 수없는 두려움을 제거합니다. "',
...
//    'joinTokenPreSale#12': '커리어 | 팀에 참여하세요 |',
    'joinTokenPreSale#13': '우리를 따라하십시오 :',
    ...
    'mvpBlock#2': '우리는 CINDX 플랫폼을 출시했습니다. 우리와 함께하십시오!',
    'mvpBlock#3': '가입',
    'mvpBlock#4': '',
    'mvpBlock#5': '',
    'mvpBlock#6': '',
