import Andrzej_Cichowlaz1 from '@assets/avatars/Andrzej_Cichowlaz1.jpg';
import Artur_Shamalov from '@assets/avatars/Artur_Shamalov.jpg';
import Askhad_Rasulov from '@assets/avatars/Askhad_Rasulov.jpg';
import Denis_Eskenazi from '@assets/avatars/Denis_Eskenazi.jpg';
import Ibraghim_Haniev from '@assets/avatars/Ibraghim_Haniev.jpg';
import Igor_Okatev from '@assets/avatars/Igor_Okatev.jpg';
import Mansur_Rasulov from '@assets/avatars/Mansur_Rasulov.jpg';
import Marc_Konovalov from '@assets/avatars/Marc_Konovalov.jpg';
import Michail_Kudryashov from '@assets/avatars/Michail_Kudryashov.jpg';
import Mofassair_Hossain from '@assets/avatars/Mofassair_Hossain.jpg';
import Rustam_Samiev from '@assets/avatars/Rustam_Samiev.jpg';
import Sofja_Pevzner from '@assets/avatars/Sofja_Pevzner.jpg';
import Stefano_Fursman from '@assets/avatars/Stefano_Fursman.jpg';
import Tigran_Hakhunts from '@assets/avatars/Tigran_Hakhunts.jpg';
import Val_Jerdes from '@assets/avatars/Val_Jerdes.jpg';
...
export const Team = [
  ...
  {
    avatar: Sofja_Pevzner,
    name: 'Sofja',
    surname: 'Pevzner',
    position: 'Member of The Board',
    achievments: [
      { number: 5, title: 'years in entrepreneurship' },
      { number: null, title: 'Permisson of estonian AML office for working ' },
      { number: 8, title: 'years of legal work expirience' }
    ]
  },
  {
    avatar: Mofassair_Hossain,
    name: 'Mofassair',
    surname: 'Hossain',
  ...
  {
    avatar: Artur_Shamalov,
    name: 'Artur',
    surname: 'Shamalov',
    position: 'Investment Director',
    achievments: [
      { number: 15, title: 'years in entrepreneurship' },
      { number: 5000, title: 'clients of mixcart.ru' },
      {
        number: null,
